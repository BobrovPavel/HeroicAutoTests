...
public class GlobalStyles_LargeFieldsTest {
    ...
    public static void setupClass() throws InterruptedException {
        ...
        supportMethod().addInputElements("large");
    ...
    /* 03.09 Тест проходит ложноположительно. Таск заведен, ожидает фикса */
    @Test
    ...
    public void stageA4_changeFontStyle_P1_PageView_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(p1FontSize, globalStyles().largeTextArea_PageView.getCssValue(Constants.FONT_SIZE));
        Assert.assertEquals(p1FontFamily, globalStyles().largeTextAreaInput_PageView.getCssValue(Constants.FONT_FAMILY));
    }
    @Test
    public void stageA5_changeFontStyle_P1_PageView_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(p1FontSize, globalStyles().largeDropList_PageView.getCssValue(Constants.FONT_SIZE));
        Assert.assertEquals(p1FontFamily, globalStyles().largeDropListInput_PageView.getCssValue(Constants.FONT_FAMILY));
    }
    @Test
    public void stageA6_changeFontStyle_P1_PageView_CheckBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(p1FontSize, globalStyles().largeCheckBox_PageView.getCssValue(Constants.FONT_SIZE));
        Assert.assertEquals(p1FontFamily, globalStyles().largeCheckBoxInput_PageView.getCssValue(Constants.FONT_FAMILY));
    }
    @Test
    public void stageA7_changeFontStyle_P1_PageView_RadioBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(p1FontSize, globalStyles().largeRadioBox_PageView.getCssValue(Constants.FONT_SIZE));
        Assert.assertEquals(p1FontFamily, globalStyles().largeRadioBoxInput_PageView.getCssValue(Constants.FONT_FAMILY));
    }
    @Test
    ...
    public void stageB4_changeFillColorWithPalette_PageView(){
        ...
        Assert.assertEquals(newValue, globalStyles().largeTextAreaInput_PageView.getCssValue(Constants.BACKGROUND_COLOR));
        Assert.assertEquals(newValue, globalStyles().largeDropListInput_PageView.getCssValue(Constants.BACKGROUND_COLOR));
    }
    @Test
    ...
    public void stageB6_changeFillColorWithPalette_PageView_Hover(){
        ...
        Assert.assertEquals(newValue, supportMethod().toRGBA(GlobalHelper.getLargeTextAreaFocusCss(Constants.BACKGROUND_COLOR)));
        Assert.assertEquals(newValue, supportMethod().toRGBA(GlobalHelper.getLargeDropListFocusCss(Constants.BACKGROUND_COLOR)));
    }
    @Test
    ...
    public void stageB9_changeFontColorWithPalette_PageView_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeDropListInput_PageView.getCssValue(Constants.COLOR));
    }
    @Test
    ...
    public void stageC2_changeFontColorWithPalette_PageView_CheckBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeCheckBoxInput_PageView.getCssValue(Constants.COLOR));
    }
    @Test
    public void stageC3_changeFontColorWithPalette_PageView_RadioBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeRadioBoxInput_PageView.getCssValue(Constants.COLOR));
    }
    @Test
    public void stageC4_changeFontColorWithPalette_OverView_Hover(){
        supportMethod().waitAndClick(globalStyles().editHover);
        supportMethod().waitAndClick(globalHelper().getFieldColors("font color"));
        globalHelper().setDefaultColorValue();
        String defaultValue = globalStyles().inputColorLable.getCssValue(Constants.BACKGROUND_COLOR);
    ...
    public void stageC6_changeFontColorWithPalette_PageView_Hover_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, supportMethod().toRGBA(GlobalHelper.getLargeTextAreaFocusCss(Constants.COLOR)));
    }
    @Test
    public void stageC7_changeFontColorWithPalette_PageView_Hover_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, supportMethod().toRGBA(GlobalHelper.getLargeDropListFocusCss(Constants.COLOR)));
    }
    @Test
    public void stageC8_changeFontColorWithPalette_PageView_Hover_CheckBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, supportMethod().toRGBA(GlobalHelper.getLargeCheckBoxFocusCss(Constants.COLOR)));
    }
    @Test
    public void stageC9_changeFontColorWithPalette_PageView_Hover_RadioBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, supportMethod().toRGBA(GlobalHelper.getLargeRadioBoxFocusCss(Constants.COLOR)));
    }
    @Test
    public void stageD1_changeBorderColorWithPalette_OverView(){
        supportMethod().waitAndClick(globalStyles().editRegular);
        ...
        globalHelper().changeColorWithColorPicker();
        globalHelper().changeCapacity();
        String afterPickValue = globalStyles().normalLargeFieldInput.getCssValue(Constants.BORDER_COLOR);
        globalHelper().changeColorWithPalette();
        String paletteColorValue = globalHelper().getColorPalette(1);
        action.click(globalHelper().getFieldColors("font color")).perform();
        newValue = globalStyles().normalLargeFieldInput.getCssValue(Constants.BORDER_COLOR);
        Assert.assertEquals(paletteColorValue, newValue);
        Assert.assertTrue(!defaultValue.equals(afterPickValue));
        Assert.assertTrue(afterPickValue.contains(Constants.CAPACITY_VALUE));
    }
    ...
    public void stageD3_changeBorderColorWithPalette_PageView_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeTextAreaInput_PageView.getCssValue(Constants.BORDER_COLOR));
    }
    @Test
    public void stageD4_changeBorderColorWithPalette_PageView_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeDropListInput_PageView.getCssValue(Constants.BORDER_COLOR));
    }
    @Test
    public void stageD5_changeBorderColorWithPalette_PageView_CheckBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeCheckBoxInput_PageView.getCssValue(Constants.BORDER_COLOR));
    }
    @Test
    public void stageD6_changeBorderColorWithPalette_PageView_RadioBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeRadioBoxInput_PageView.getCssValue(Constants.BORDER_COLOR));
    }
    @Test
    public void stageD7_changeBorderColorWithPalette_OverView_Hover(){
        supportMethod().waitAndClick(globalStyles().editHover);
        supportMethod().waitAndClick(globalHelper().getFieldColors("border color"));
        globalHelper().setDefaultColorValue();
        String defaultValue = globalHelper().getDefaultColorValue();
    ...
    public void stageD9_changeBorderColorWithPalette_PageView_Hover_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeTextAreaFocusCss(Constants.BORDER_COLOR));
    }
    @Test
    public void stageE1_changeBorderColorWithPalette_PageView_Hover_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeDropListFocusCss(Constants.BORDER_COLOR));
    }
    @Test
    public void stageE2_changeBorderColorWithPalette_PageView_Hover_Checkbox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeCheckBoxFocusCss(Constants.BORDER_COLOR));
    }
    @Test
    public void stageE3_changeBorderColorWithPalette_PageView_Hover_RadioBox(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeRadioBoxFocusCss(Constants.BORDER_COLOR));
    }
    @Test
    ...
    public void stageE6_changeBorderThickness_PageView_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeTextAreaInput_PageView.getCssValue(Constants.BORDER_WIDTH));
    }
    @Test
    public void stageE7_changeBorderThickness_PageView_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeDropListInput_PageView.getCssValue(Constants.BORDER_WIDTH));
    }
    @Test
    ...
    public void stageF1_changeBorderThickness_PageView_Hover_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeTextAreaFocusCss(Constants.BORDER_WIDTH));
    }
    @Test
    public void stageF2_changeBorderThickness_PageView_Hover_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeDropListFocusCss(Constants.BORDER_WIDTH));
    }
    @Test
    ...
    public void stageF5_changeBorderRadius_PageView_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeTextAreaInput_PageView.getCssValue(Constants.BORDER_RADIUS));
    }
    @Test
    public void stageF6_changeBorderRadius_PageView_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, globalStyles().largeDropListInput_PageView.getCssValue(Constants.BORDER_RADIUS));
    }
    @Test
    ...
    public void stageF9_changeBorderRadius_PageView_Hover_TextArea(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeTextAreaFocusCss(Constants.BORDER_RADIUS));
    }
    @Test
    public void stageG1_changeBorderRadius_PageView_Hover_DropList(){
        supportMethod().waitAndClick(globalStyles().pageViewMode);
        Assert.assertEquals(newValue, GlobalHelper.getLargeDropListFocusCss(Constants.BORDER_RADIUS));
    }
