...
//        webDriver.get("https://app.heroicnow.com/?token=66acd0e66964e5dfd488648139148f07e5ea4c4b");
    ...
    public void alignment_Paragraph() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath(Variables.leftAlign),1));
        Assert.assertTrue(webDriver.findElements(By.xpath(Variables.leftAlign)).size() > 0);
        tinymceHelper().applyAlignCenter();
        wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath(Variables.centerAlign), 1));
        Assert.assertTrue(webDriver.findElements(By.xpath(Variables.centerAlign)).size() > 0);
        tinymceHelper().applyAlignRight();
        wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath(Variables.rightAlign), 1));
        Assert.assertTrue(webDriver.findElements(By.xpath(Variables.rightAlign)).size() > 0);
        tinymceHelper().applyAlignFull();
        wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath(Variables.fullAlign), 1));
    ...
    public void boid_italic_underline_quote_capacity_Paragraph_part(){
        ...
        Assert.assertEquals(Variables.THREE_SIMPLE_TEXT, webDriver.findElement(By.xpath(Variables.elementSpan)).getText());
        Assert.assertTrue(finish.contains("0.46"));
    }
    @Test
