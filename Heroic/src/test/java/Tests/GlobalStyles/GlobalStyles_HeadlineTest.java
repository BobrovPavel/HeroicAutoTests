...
//        supportMethod().createElement("header");
    ...
    @Test
    public void stageA1_changeFontFamily_H1_OverView() throws InterruptedException {
    ...
    @Test
    public void stageA2_changeFontSize_H1_OverView() throws InterruptedException {
        ...
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageA3_changeLineHeight_H1_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        ...
        supportMethod().waitAndClick(globalStyles().overViewMode);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h1lineHeight, "font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(1, "line height");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageA4_changLetterSpacing_H1_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        ...
        supportMethod().waitAndClick(globalStyles().overViewMode);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h1Item, "letter-spacing","1.5px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(1, "letter spacing");
        Assert.assertEquals(String.valueOf(supportMethod().asDouble(defaultValue)), String.valueOf(supportMethod().asDouble(oldValue)));
    }
    @Test
    public void stageA5_changeParagraphSpacing_H1_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        ...
        supportMethod().waitAndClick(globalStyles().overViewMode);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h1Paragraph,"margin-bottom","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(1, "paragraph spacing");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
//    @Test
//    public void stageA6_changeDarkColor_H1_OverView() throws InterruptedException {
//        supportMethod().waitAndClick(globalStyles().darkTextColor);
//        globalHelper().setDefaultColorValue();
//        wait.until(ExpectedConditions.attributeToBe(globalStyles().h1Item, "color","rgba(0, 0, 0, 1)"));
//        String defaultValue = globalHelper().getHeadlineGlobalValue(1,"dark color");
//        globalHelper().changeColorWithColorPicker();
//        Thread.sleep(500);
//        String newValue = globalHelper().getHeadlineGlobalValue(1,"dark color");
//        Assert.assertTrue(!defaultValue.equals(newValue));
//        globalHelper().setDefaultColorValue();
//    }
    @Test
    public void stageB1_changeFontFamily_H2_OverView() throws InterruptedException {
        supportMethod().waitAndClick(globalStyles().globalH2);
        supportMethod().waitAndClick((WebElement) globalHelper().getHeaderFontDropdown_globalStyle().get(1));
        supportMethod().waitAndClick(globalStyles().asap_font);
    ...
    @Test
    public void stageB2_changeFontSize_H2_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h2Item,"font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(2, "font size");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageB3_changeLineHeight_H2_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h2lineHeight, "font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(2, "line height");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageB4_changLetterSpacing_H2_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), "1.5");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h2Item, "letter-spacing","1.5px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(2, "letter spacing");
        Assert.assertEquals(String.valueOf(supportMethod().asDouble(defaultValue)), String.valueOf(supportMethod().asDouble(oldValue)));
    }
    @Test
    public void stageB5_changeParagraphSpacing_H2_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h2Paragraph,"margin-bottom","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(2, "paragraph spacing");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }


    @Test
    public void stageC1_changeFontFamily_H3_OverView() throws InterruptedException {
        supportMethod().waitAndClick(globalStyles().globalH3);
        supportMethod().waitAndClick((WebElement) globalHelper().getHeaderFontDropdown_globalStyle().get(2));
        supportMethod().waitAndClick(globalStyles().asap_font);
    ...
    @Test
    public void stageC2_changeFontSize_H3_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h3Item,"font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(3, "font size");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageC3_changeLineHeight_H3_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h3lineHeight, "font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(3, "line height");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageC4_changLetterSpacing_H3_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), "1.5");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h3Item, "letter-spacing","1.5px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(3, "letter spacing");
        Assert.assertEquals(String.valueOf(supportMethod().asDouble(defaultValue)), String.valueOf(supportMethod().asDouble(oldValue)));
    }
    @Test
    public void stageC5_changeParagraphSpacing_H3_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h3Paragraph,"margin-bottom","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(3, "paragraph spacing");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }


    @Test
    public void stageD1_changeFontFamily_H4_OverView() throws InterruptedException {
        supportMethod().waitAndClick(globalStyles().globalH4);
        supportMethod().waitAndClick((WebElement) globalHelper().getHeaderFontDropdown_globalStyle().get(3));
        supportMethod().waitAndClick(globalStyles().asap_font);
    ...
    @Test
    public void stageD2_changeFontSize_H4_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h4Item,"font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(4, "font size");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageD3_changeLineHeight_H4_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h4lineHeight, "font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(4, "line height");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageD4_changLetterSpacing_H4_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), "1.5");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h4Item, "letter-spacing","1.5px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(4, "letter spacing");
        Assert.assertEquals(String.valueOf(supportMethod().asDouble(defaultValue)), String.valueOf(supportMethod().asDouble(oldValue)));
    }
    @Test
    public void stageD5_changeParagraphSpacing_H4_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h4Paragraph,"margin-bottom","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(4, "paragraph spacing");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    ...
    public void stageE1_changeFontFamily_H5_OverView() throws InterruptedException {
        ...
        supportMethod().waitAndClick((WebElement) globalHelper().getHeaderFontDropdown_globalStyle().get(4));
        supportMethod().waitAndClick(globalStyles().abril_Fatface_font);
    ...
    @Test
    public void stageE2_changeFontSize_H5_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h5Item,"font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(5, "font size");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageE3_changeLineHeight_H5_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h5lineHeight, "font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(5, "line height");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageE4_changLetterSpacing_H5_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), "1.5");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h5Item, "letter-spacing","1.5px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(5, "letter spacing");
        Assert.assertEquals(String.valueOf(supportMethod().asDouble(defaultValue)), String.valueOf(supportMethod().asDouble(oldValue)));
    }
    @Test
    public void stageE5_changeParagraphSpacing_H5_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h5Paragraph,"margin-bottom","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(5, "paragraph spacing");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    ...
    public void stageF1_changeFontFamily_H6_OverView() throws InterruptedException {
        ...
        supportMethod().waitAndClick((WebElement) globalHelper().getHeaderFontDropdown_globalStyle().get(5));
        supportMethod().waitAndClick(globalStyles().abril_Fatface_font);
    ...
    @Test
    public void stageF2_changeFontSize_H6_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(0), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h6Item,"font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(6, "font size");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageF3_changeLineHeight_H6_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(1), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h6lineHeight, "font-size","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(6, "line height");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
    @Test
    public void stageF4_changLetterSpacing_H6_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), "1.5");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(2), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h6Item, "letter-spacing","1.5px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(6, "letter spacing");
        Assert.assertEquals(String.valueOf(supportMethod().asDouble(defaultValue)), String.valueOf(supportMethod().asDouble(oldValue)));
    }
    @Test
    public void stageF5_changeParagraphSpacing_H6_OverView() throws InterruptedException {
        Actions action = new Actions(webDriver);
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), "50");
        ...
        globalHelper().setDefaultValue(globalHelper().getInputGlobalStyles().get(3), defaultValue);
        wait.until(ExpectedConditions.attributeToBe(globalStyles().h6Paragraph,"margin-bottom","50px"));
        String oldValue = globalHelper().getHeadlineGlobalValue(6, "paragraph spacing");
        Assert.assertEquals(supportMethod().asInt(defaultValue), supportMethod().asInt(oldValue));
    }
