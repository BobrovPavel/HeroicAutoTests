...
public class InitTest {
    ...
    @Test
    public void t2(){
        webDriver.findElement(By.xpath("//*[contains(@class,'icon-svg-settings')]")).click();
        webDriver.findElement(By.xpath("//a[contains(text(),'Integrations')]")).click();
        webDriver.findElement(By.xpath("//button[contains(text(),'Add New Integration')]")).click();
        webDriver.findElement(By.xpath("//div[@class='without-accordion']//input")).sendKeys("1");
        webDriver.findElement(By.xpath("//*[contains(@class,'icon-svg-arrow-right-button')]")).click();
    }
